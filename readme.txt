...
Best coding practices was applied on this boilerplate by strictly following the WP Docs, you can join the project on GitHub [Note For Posts Project](https://github.com/esstat17/Note-For-Posts/ "Note For Posts Project").
